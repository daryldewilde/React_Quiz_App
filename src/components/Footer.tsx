...
export default function Footer() {
    ...
    return (
        <Box className={`flex flex-col md:flex-row items-center justify-around h-auto md:h-16 p-3 md:p-5 border-t w-full ${themeContext.theme === "dark" ? "bg-gray-900 border-gray-700 text-white" : "bg-gray-800 border-gray-300 text-white"}`} component="footer">
